...
s1 = Service.create(name:"Hydra", description:"hydration", image:"/app/views/layouts/eyeImage.jpeg", price:"100")
s2 = Service.create(name:"rejuvenating", description:"anti-aging", image:"", price:"110")
s3 = Service.create(name:"hand", description:"hand treatment", image:"/app/views/layouts/handServiceImage.jpeg", price:"50")
